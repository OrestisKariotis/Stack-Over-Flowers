...
public class LoginController {
    ...
    public Parent Parent_login(@RequestParam String username, @RequestParam String password) {  // OK
    ...
    public Provider Provider_login(@RequestParam String username, @RequestParam String password) {   // OK
