...
public class MonthProviderReferenceDao {  //CHECKING
    ...
    public void addMonthProviderReference(MonthProviderReference monthProviderReference) { // OK
        jdbcTemplate.update("INSERT INTO MonthProviderReferences (provider_id, january_profit, february_profit, march_profit, april_profit, may_profit, june_profit, july_profit, august_profit, september_profit, octomber_profit, november_profit, december_profit) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
