...
//public	final String password = "stack-over-flowers";
    ...
    public void sendSimpleMail(String EmailTo, String text) {
        ...
        try {
            ...
            message.setSubject("Kidspiration: Ειδοποίηση");
        ...
        try {
            ...
            message.setRecipients(Message.RecipientType.TO,
                    InternetAddress.parse(EmailTo));
            //InternetAddress.parse("giannis.plakas@yahoo.gr"));
            message.setSubject("Kidspiration: Αλλαγή Κωδικού");
    ...
    public void sendCheckEmail(String EmailTo, String id) {
        ...
        try {
            ...
            message.setRecipients(Message.RecipientType.TO,
                    InternetAddress.parse(EmailTo));
            //InternetAddress.parse("giannis.plakas@yahoo.gr"));
            message.setSubject("Kidspiration: Απόδειξη αγοράς εισιτηρίου");
            message.setText("Στο pdf θα βρείτε την απόδειξη αγοράς εισιτηρίου,"
                    + "\n\n"
                    + ""
                    + ""
                    + ""
            ...
            // src/main/resources/checks/"+id+".pdf

            String file = dir + "/src/main/resources/checks/"+id+".pdf";
