...
public class ParentProfileController {
    ...
    public List<TicketView> ParentProfile_Tickets(@RequestParam String id) {  //parameters may change

        // show tickets
        return ticketService.findAll_byParentId_TicketView(Integer.parseInt(id));
    }

    @RequestMapping(path = "/old_tickets", method = RequestMethod.GET)  // NOT checked for not empty list
    ...
    @RequestMapping(path = "/personal_info", method = RequestMethod.GET)
    ...
    @RequestMapping(path = "/personal_info/edit", method = RequestMethod.GET) // POST  method!!!
