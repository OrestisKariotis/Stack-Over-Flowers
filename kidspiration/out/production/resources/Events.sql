...
/* ADDED */
/* Info Insertion */
INSERT INTO kidspiration.CurrentEvents(provider_id, title, date, starting_time, place, type, ticket_cost, initial_ticketsNumber, available_ticketsNumber, lowestAge, highestAge, latitude, longitude, description) VALUES(1, "FOOTBALL GAME", curdate(), "21:00", "Vironas, Damaria", "Sports", 50, 10, 5, 20, 25, 37.97864720247794,23.78350140530576, "A great night for football!"),
  (3, "VAN GOGH ALIVE", STR_TO_DATE('1-01-2018', '%d-%m-%Y'), "12:00", "Megaro Mousikis", "Art", 200, 50, 50, 12, 90, 39.974720247794,24.783540530576, "Live the myth!"), (2, "BASKETBALL GAME", curdate(), "11:00", "Vironas, Nekrotafeio", "Sports", 50, 10, 9, 20, 25, 37.978620247794,23.783501430576, "A great night for basketball!");
...
INSERT INTO kidspiration.PendingEvents(provider_id, title, date, starting_time, place, type, ticket_cost, initial_ticketsNumber, lowestAge, highestAge, description) VALUES(1, "GeoTesting", curdate(), "10:34", "Συβρισσαριου 18 Βυρωνας", "Art", 10, 2, 19, 40, "Testing geocoding of coordinates during pending event's acceptance.")